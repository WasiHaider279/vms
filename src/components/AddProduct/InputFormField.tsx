...
const InputFormField: React.FC<InputFieldProps> = ({
  name,
  placeholder,
  register,
  label,
  ...
  return (
    <div className="w-full flex-col justify-start items-start gap-2 inline-flex">
      ...
      <input
        ...
        className="px-4 py-3 border rounded-lg w-full bg-white border-zinc-100 placeholder-gray-300 text-black text-sm font-normal font-inter"
        {...register(`${name}`, {
